...
export function Footer() {
  return (
    <footer className="bg-[#1C1C1C] text-[#FAF7F2] border-t border-brand-primary/10 pt-20 pb-10">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 pb-16 border-b border-white/5">
          ...
          <div className="lg:col-span-2 flex flex-col items-start pr-0 lg:pr-12">
            <Link
              href="/"
              className="text-2xl font-heading font-black tracking-[0.3em] uppercase text-white mb-6"
            >
              AD Atlas
            </Link>
            <p className="text-xs font-light text-neutral-400 leading-relaxed uppercase tracking-wider mb-8 max-w-sm">
          ...
          {/* Links columns */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.25em] text-brand-accent mb-6">
              Shop Collections
            </h4>
        ...
        <div className="pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-2">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-[9px] uppercase tracking-widest text-neutral-500">
          ...
          {/* Payment Badges and compliance */}
          <div className="flex flex-col items-center md:items-end gap-3">
            <span className="text-[9px] tracking-widest text-neutral-500 uppercase">
              Secure Checkout Partners
            </span>
            <div className="flex items-center gap-4 text-xs font-bold text-neutral-500 select-none">
              <span>RAZORPAY</span>
